...
Wait for the new pod to be ready before starting the workflow, otherwise it might land on the previous version:

```bash
kubectl wait --for=condition=Ready pod -l app=research-agent --timeout=60s
