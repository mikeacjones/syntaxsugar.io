...
4. Give the API a title; `Product System API`
...
![create-product-api-spec.gif](create-product-api-spec.gif)
...
Another prime candidate for a query parameter is the field `manufactured`. By default, we won't be filtering any products, so lets go ahead and add it as an optional field:
...
![create-product-api-project.gif](create-product-api-project.gif)
...
![setup-mysql-database-config.gif](setup-mysql-database-config.gif)
...
![product-api-setup-sql-select.gif](product-api-setup-sql-select.gif)
